...
verification:
  commands:
    ...
    - poetry run python -c "import os, subprocess, sys; env={**os.environ, 'QUANTIQMT_POSTGRES_DSN':'postgresql://quantiqmt:quantiqmt@localhost:55432/quantiqmt_task052'}; raise SystemExit(subprocess.call([sys.executable, '-m', 'pytest', 'tests/unit/order/application', 'tests/contract/persistence', 'tests/integration/persistence'], env=env))"
