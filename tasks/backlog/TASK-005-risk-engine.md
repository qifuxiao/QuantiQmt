...
TASK-015 已在 Spec 0.6 冻结 RiskInput、Snapshot DTO、RuleSet、规则排序、硬限额、fail-closed taxonomy、减仓例外、RiskDecision 和审计输出契约。本任务在 TASK-015 通过独立 Review 并由人类/Review Agent 标记 completed 前仍保持 blocked；完成该 gate 后无需再发明 Risk DTO、规则 DSL、错误码或计时语义即可激活实现。
