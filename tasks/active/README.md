...
TASK-022 and TASK-049 are the active tasks.
...
TASK-049 is human-authorized to make governance validator tests time-deterministic and cleanup-safe. It may modify only its task metadata, `scripts/validate_specs.py`, and `tests/spec/test_validate_specs.py`; it cannot alter waiver history, business contracts, task unlocks, or release state.
